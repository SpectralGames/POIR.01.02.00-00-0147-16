...
public class TimeSpawnBar : BarElement
{
    private Image imageBackground;
    private Image image;

    public TimeSpawnBar (AI ai, GameObject go)
    {
        Init(ai, go);
    }
    ...
    public override void Init (AI ai, GameObject go)
    {
        ...
        imageBackground = go.FindComponentInChildWithName<Image>("TimeBackground");
        image = go.FindComponentInChildWithName<Image>("Time");
