...
public class UITranslationAnimator : UIAnimationEngine {
	...
	public override void PrepareAnimation()
	{
		...
		tempValueTo = valueTo;
		initValue = rectTransform.localPosition;
	...
	public override void ClearValues()
	{
		...
		rectTransform.localPosition = initValue;
	}
	...
	public override void OnAnimation()
	{
		if (currentAnimationTime < timeInSeconds) {
			...
			if (currentAnimationTime >= 0) {
				...
				rectTransform.localPosition = currentValue;
			}
		} else {
			rectTransform.localPosition = valueTo;
			OnFinishAnimation ();
		}
	}
